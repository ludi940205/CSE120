 ...
 ******************************************************************************************/
    ...
    printf("++ISPRMGR: ARG[1] is %d \n", variation);

    if (variation) {
        route(variation, dbg_flag);
    }
    else {
        printf("++ISPRMGR Run all the variations\n");
        for (i=1; i <= NUMVARS; i++)
            route(i, dbg_flag);
    }
...
void route(int variation, char dbg_flag)   
{
    ...
    switch (variation)
    {
        ...
        case 1:
            ...
            /*                                                           */
            /*************************************************************/
            printf("++ISPRMGR VAR1: [STARTED]\n");
            executable = "exittest.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 1;
            printf("++ISPRMGR VAR1: exec %s\n", executable);
            pid[0] = exec(executable, _argc, _argv);
            printf("++ISPRMGR VAR1: Child process id is %d\n", pid[0]);
            ...
            pid[0] = exec(executable, _argc, _argv);
            printf("++ISPRMGR VAR1: Child process id is %d\n", pid[0]);
            printf("++ISPRMGR VAR1: [ENDED] SUCCESS\n");
        ...
        case 2:
            ...
            printf("++ISPRMGR VAR2: [ENDED] SUCCESS\n");
        ...
        case 3:
            ...
            /*                                                           */
            /*************************************************************/
            printf("++ISPRMGR VAR3: [STARTED]\n");
            
            executable = "exittest.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 1;
            printf("++ISPRMGR VAR3: exec %s\n", executable);
            pid[0] = exec(executable, _argc, _argv);
            ...
            if (retval == 0) {
                ...
                printf("++ISPRMGR VAR3: return value of join is %d\n", retval);
                printf("++ISPRMGR VAR3: [ENDED] FAIL\n");
            }
        ...
        case 4:
            ...
            /*                                                                       */
            /*************************************************************************/
            printf("++ISPRMGR VAR4: [STARTED]\n");
            printf("++ISPRMGR VAR4: invoke exec with nonextent executable\n");
            executable = "inexistent.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 1; 
            printf("++ISPRMGR VAR4: exec %s\n", executable);
            retval = exec(executable, _argc, _argv);
            if (retval == -1)
                printf("++ISPRMGR VAR4: [END] SUCCESS\n");
            else
                printf("++ISPRMGR VAR4: [END] FAIL\n");
        ...
        case 5:
            ...
            /*                                                                       */
            /*************************************************************************/
            printf("++ISPRMGR VAR5: [STARTED]\n");
            printf("++ISPRMGR VAR5: invoke exec with unmatched argc\n");
            executable = "exittest.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 100; 
            printf("++ISPRMGR VAR5: exec %s\n", executable);
            retval = exec(executable, _argc, _argv);
            if (retval != -1) {
                printf("++ISPRMGR VAR5: [END] FAIL\n");
                break;
            }
            ...
            retval = exec(executable, _argc, _argv);
            if (retval != 0) {
                printf("++ISPRMGR VAR5: Retval of exec is %d \n", retval);
                printf("++ISPRMGR VAR5: [END] SUCCESS\n");
            }
            else
                printf("++ISPRMGR VAR5: [END] FAIL\n");
        ...
        case 6:
        {
            ...
            /*                                                                       */
            /*************************************************************************/
            printf("++ISPRMGR VAR6: [STARTED]\n");
            printf("++ISPRMGR VAR6: Issue join to a non-child with pid=0\n");
            
            retval = join(0, &exitstatus);
            if (retval == 0) {
                printf("++ISPRMGR VAR6: [ENDED] FAIL\n");
                break;
            }

            printf("++ISPRMGR VAR6: Issue join to myself with pid=1\n");
            ...
            printf("++ISPRMGR VAR6: [ENDED] SUCCESS\n");
        }
        ...
        case 7:
            ...
            /*                                                                       */
            /*************************************************************************/
            printf("++ISPRMGR VAR7: [STARTED]\n");
            printf("++ISPRMGR VAR7: test your syscall join to be invoked more than once\n");
            
            executable = "exittest.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 1;
            printf("++ISPRMGR VAR7: exec %s\n", executable);
            pid[0] = exec(executable, _argc, _argv);
            ...
            printf("++ISPRMGR VAR7: first time invoke join successfully\n");
            ...
            printf("++ISPRMGR VAR7: failed to invoke join second time as exptected\n");

            printf("++ISPRMGR VAR7: [ENDED] SUCCESS\n");
        ...
        case 8:
            ...
            /*                                                                       */
            /*************************************************************************/
            printf("++ISPRMGR VAR8: [STARTED]\n");
            printf("++ISPRMGR VAR8: tests syscall join to a child that caused unhandled exception\n");
            
            executable = "exception.coff";
            _argv[0] = executable;
            _argv[1] = NULL;
            _argc = 1; 
            printf("++ISPRMGR VAR8: exec %s\n", executable);
            pid[0] = exec(executable, _argc, _argv);
            if (pid[0] < 0) {
                printf("++ISPRMGR VAR8: [ENDED] FAIL to invoke exec\n");
                break;
            }

            printf("++ISPRMGR VAR8: Issue join to child with pid=%d\n", pid[0]);
            retval = join(pid[0], &exitstatus);
            if (exitstatus == 0) {
                printf("++ISPRMGR VAR8: Issue join successfully, but expect a failure at here\n");
                printf("++ISPRMGR VAR8: [ENDED] FAIL\n");
                break;
            }
            else {
                printf("++ISPRMGR VAR8: failed to issue join as expected\n");
                printf("++ISPRMGR VAR8: [ENDED] SUCCESS\n");
            }
